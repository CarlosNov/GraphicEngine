...
namespace GraphicEngine
{
	...
	void SceneLoader::Save(const std::string& filepath)
	{
		YAML::Emitter out;
	...
	static void SaveEntity(YAML::Emitter& out, Entity entity)
	{
		...
		if (entity.HasComponent<CameraComponent>())
		{
			...
			out << YAML::Key << "OrthographicSize" << YAML::Value << camera.GetOrtographicSize();
		...
		if (entity.HasComponent<MeshComponent>())
		{
			...
			out << YAML::Key << "Path" << YAML::Value << mesh.FileName;
	...
	bool SceneLoader::Load(const std::string& filepath)
	{
